...
@Composable
fun ClassicGameScreen( musicViewModel: MusicViewModel,gameStatsViewModel: GameStatsViewModel = viewModel()) {
    var answer by rememberSaveable {
        mutableStateOf(generateRandomNumberFrom1to100().toString() ?: "0")
    }
...
//                            label = { Text("Enter Upper Limit") },
                    ...
                    Button(
                        ...
                        if (!gameOver && userGuess.isNotBlank()) {
                        attempts++
